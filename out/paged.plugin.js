      ...
      PagedPlugin.prototype.renderBefore = function(opts, next) {
        ...
        sourcePageDocuments.forEach(function(document) {
          return tasks.addGroup(function(addGroup, addTask) {
            var basename, extension, filePath, filename, lastDoc, meta, numberOfPages, outBasename, outExtension, outFilename, outputNumbersOnly, pageSize, pagedCollection, pagedCollectionName, pages, pagesOutBasePath, relativePath, url, _i, _results;
            meta = document.getMeta();
            numberOfPages = meta.get('pageCount') || 1;
            pageSize = meta.get('pageSize') || 1;
            lastDoc = pageSize * numberOfPages;
            pagesOutBasePath = meta.get('pagesOutBasePath') || '';
            outputNumbersOnly = meta.get('outputNumbersOnly') || false;
            ...
            if (numberOfPages > 1) {
              return (function() {
                ...
                return addTask(function(complete) {
                  var pageDocument, pageFilename, pageOutFilename, pageOutPath, pageRelativePath, _ref;
                  pageFilename = "" + basename + "-" + pageNumber + "." + extension;
                  pageOutPath = pagesOutBasePath;
                  pageOutPath += outputNumbersOnly ? '' : "" + outBasename + ".";
